  ...
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        "description": "Under this scheme, businesses must prepare the required documents, affidavits, and certificates for submitting an application form following CLCSS norms. Liaison with the concerned office is necessary to obtain the sanction and release of the subsidy amount."
      },
      {
        "title": "NHB / APEDA Subsidy",
        "description": "To access subsidies under NHB (National Horticulture Board) or APEDA (Agricultural and Processed Food Products Export Development Authority), businesses need to submit an application form as per the respective norms. This process involves arranging pre and post-inspections by NHB or APEDA officials and preparing the required documents and certificates for subsidy approval."
      },
      {
        "title": "MOFPI Subsidy",
        "description": "Securing subsidies under the Ministry of Food Processing Industries (MOFPI) requires the submission of an application form in accordance with MOFPI norms. Businesses must facilitate pre and post-inspections by MOFPI officials and prepare the necessary documents and certificates for subsidy approval."
      },
      {
        "title": "Venture Capital from SFAC",
        "description": "For venture capital support from the Small Farmers Agribusiness Consortium (SFAC), businesses should submit an application form according to SFAC norms. This process involves arranging joint inspections with SFAC officials to obtain venture capital funding."
      },
      {
        "title": "Electronic System Design & Manufacturing (ESDM) Subsidy (State)",
        "description": "Accessing electronic subsidies under the ESDM scheme at the state level requires businesses to prepare the necessary documents, affidavits, and certificates and submit an application form as per ESDM norms. Liaison with the concerned office is crucial for obtaining the subsidy."
      },
      {
        "title": "Modified Special Incentive Package Scheme (M-SIPS) for Electronic Subsidy (Central)",
        "description": "Businesses seeking electronic subsidies under M-SIPS at the central level must prepare the required documents, affidavits, and certificates and submit an application form following M-SIPS norms. Liaison with the concerned office is essential for subsidy approval."
      },
      {
        "title": "Amended Technology Upgradation Fund Scheme (ATUFS) for Textile Subsidy",
        "description": "To access subsidies under ATUFS for textiles, businesses should prepare the required documents, affidavits, and certificates and submit an application form following ATUFS norms. Liaison with the concerned office is important for obtaining subsidy approval."
      },
      {
        "title": "Integrated Development of Leather Sector (IDLS) Scheme for Leather Subsidy",
        "description": "Businesses seeking subsidies under the IDLS scheme for the leather sector must prepare the required documents, affidavits, and certificates and submit an application form following IDLS norms. Liaison with the concerned office is crucial for obtaining subsidy approval."
      }
    ]
  },
  {
    ...
    keyPoints: [
      ...
      {
        "title": "Registrations",
        "description": "Obtain essential registrations, including PAN, TAN, CST, and GST registration, to comply with tax and regulatory requirements."
      },
      {
        "title": "Land Due Diligence",
        "description": "Conduct due diligence on the land or plot to ensure it complies with environmental clearance, Pollution Control Board norms, zoning regulations, and FSI norms as per DC Rules."
      },
      {
        "title": "Local Body NOC",
        "description": "Secure a No Objection Certificate (NOC) from the Grampanchayat or Local Body to establish your unit."
      },
      {
        "title": "Industrial Entrepreneurs Memorandum (IEM)",
        "description": "File the required IEM - Part A or B with the Secretariat for Industrial Assistance (SIA) in New Delhi."
      },
      {
        "title": "MSME Udyog Aadhar Certificate",
        "description": "Obtain the MSME Udyog Aadhar Certificate from the District Industries Centre (DIC) if your business falls under the MSME category."
      },
      {
        "title": "Professional Tax Registrations",
        "description": "Register for Professional Tax, including PTEC and PTRC, as required by your business type."
      },
      {
        "title": "GSTIN Registration",
        "description": "Get the GSTIN Registration Certificate to comply with Goods and Services Tax (GST) regulations."
      },
      {
        "title": "ESIC Registration",
        "description": "Register with the Employees' State Insurance Corporation (ESIC) for employee insurance benefits."
      },
      {
        "title": "Provident Fund Registration",
        "description": "Obtain the Provident Fund (PF) registration certificate for employee retirement benefits."
      },
      {
        "title": "Pollution Control Board Approvals",
        "description": "Secure the Consent to Establish (C to E) and Consent to Operate (C to O) from the Maharashtra Pollution Control Board."
      },
      {
        "title": "Fire NOC",
        "description": "Obtain provisional and final Fire NOCs from the Directorate of Maharashtra Fire Services, Mumbai (DOMFS)."
      },
      {
        "title": "Power Supply",
        "description": "Arrange for L.T. or Express H.T. power supply from MSEDCL and ensure compliance with electrical and safety standards."
      },
      {
        "title": "Factory Plan Approval",
        "description": "Seek approval of the factory plans from the Directorate of Industrial Safety & Health Department (DISH) under the Factories Act 1948."
      },
      {
        "title": "Food License",
        "description": "Obtain a Food License from the Food Safety and Standards Authority of India (FSSAI) if your project involves food production."
      },
      {
        "title": "Trademark Registrations",
        "description": "Register trademarks and logos with the relevant authorities to protect your intellectual property."
      },
      {
        "title": "Bar Code Registration",
        "description": "Complete Bar Code Registration to comply with labeling and tracking requirements."
      },
      {
        "title": "NSIC Registrations",
        "description": "Register with the National Small Industries Corporation (NSIC) to avail benefits and support for small enterprises."
      },
      {
        "title": "Electrical Inspection",
        "description": "Arrange for electrical inspections, including Transformer and H.T. line inspections, by certified inspectors."
      },
      {
        "title": "Factory License",
        "description": "Obtain a Factory License from the Directorate of Industrial Safety & Health Department (DISH) as per the Factories Act 1948."
      },
      {
        "title": "Central Ground Water Authority",
        "description": "Acknowledge compliance with Central Ground Water Authority (CGWA) regulations."
      },
      {
        "title": "PESO Approvals",
        "description": "Obtain approvals and registrations from the Petroleum and Explosives Safety Organization (PESO) if your project involves hazardous materials."
      },
      {
        "title": "Machinery Calibration",
        "description": "Ensure the calibration of machinery as required by the Weights & Measurement Department."
      },
      {
        "title": "BIS License",
        "description": "Secure a Bureau of Indian Standards (BIS) License for ISI marks certification if applicable."
      },
      {
        "title": "Import Export (IE) Code",
        "description": "Obtain an Import Export (IE) Code License for international trade operations."
      },
      {
        "title": "Export Promotional Councils (EPCs)",
        "description": "Register with various Export Promotional Councils (EPCs) like APEDA, Spice Board of India, and Chemexcil to access export-related benefits."
      },
      {
        "title": "Winery Setup",
        "description": "For winery projects, obtain a Letter of Intent (LOI), BRL Licenses, and necessary approvals for wine manufacturing and sale."
      },
      {
        "title": "E2 License",
        "description": "Secure an E2 License for the sale of wine on the premises of hotels, restaurants, and clubs."
      }
    ]
  }
]
